export default {
  "sicknesses": [
    ...
    "anticonvulsivant",
    "aplasie médulaire idiopathique",
    ...
    "érythème urticariforme",
    "état post-critique",
    "étio fonctionnel",
    "exanthème fébrile",
    "exanthème subit",
    "fièvre ä du nourrisson < 3 mois",
    "fièvre ä du nourrisson < 5 ans",
    "fièvre boutonneuse méditerranéenne",
    "fièvre d'origine indéterminée",
    "fièvre d'origine infectieuse",
    "fièvre en rapport avec une m inflammatoire",
    "fièvre factice",
    ...
    "insuffisance surrénale ch",
    "intoxication ä AD3C",
    "intoxication ä barbiturique",
    "intoxication ä BZD",
    "intoxication ä CO",
    "intoxication ä CO",
    "intoxication ä héroïne",
    "intoxication ä insecticide organophosphoré",
    "intoxication ä lithium",
    "intoxication ä morphine",
    "intoxication mercure",
    "intoxication plomb",
    "intoxication salycilé",
    "iodure",
    "ISA",
    "ISA",
    "IU",
    ...
    "sarcoïdose",
    "scarlatine",
    "score hémorragique de Buchanan",
    "sd d'Alagille",
    "sd de choc toxique",
